  ...
  render() {
    return (
      <div>
        ...
        <PostList handleDeletePost={this.handleDeletePost} handleVoteUpPost={this.handleVoteUpPost} handleVoteDownPost={this.handleVoteDownPost} handleEditPost={this.handleEditPost} posts={this.props.posts} />
      </div>
    );
  }
}
